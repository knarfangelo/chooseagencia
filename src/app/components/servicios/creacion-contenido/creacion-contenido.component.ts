...
@Component({
  ...
  template: `
   ...
   <iframe src="https://player.vimeo.com/video/946399549?h=ec96ea06ef" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe> <img src="/servicios/creacion-contenido-informacion.jpg" alt="video de creacion de contenido de la agencia de marketing de choose">
