...
@Component({
  ...
  template: `
   ...
   <iframe src="https://player.vimeo.com/video/946398864?h=00ff0d2a6f" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe> <img src="/servicios/desarrollo-web-informacion.jpg" alt="video de desarrollo web de la agencia de marketing de choose">
